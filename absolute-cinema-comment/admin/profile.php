...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        // ถ้ามีการเปลี่ยนรหัสผ่าน เข้ารหัสรหัสผ่านใหม่ แล้วอัปเดตรหัสผ่านพร้อมเบอร์โทร
        if (!empty($password)) {
...
<body>
    ...
    <!-- Profile Container กล่องโปรไฟล์ผู้ใช้ แสดงข้อความแจ้งเตือนเมื่อมีการอัปเดตข้อมูลสำเร็จหรือเกิดข้อผิดพลาด -->
...
รหัสผ่านใหม่ (ให้กรอกเฉพาะตอนเปลี่ยน)
เบอร์โทร (แก้ไขได้)
วันที่สมัครสมาชิก (อ่านอย่างเดียว) -->
